pipeline {
  ...
  stages {
    ...
    stage ('Nexus Upload') {
      ...
      nexusVersion: 'nexus3',
      protocol: 'http',
      nexusUrl: 'http://http://http://ec2-54-89-27-109.compute-1.amazonaws.com:8081/',
      groupId: 'myGroupId',
    ...
    stage ('DEV Deploy') {
      ...
      deploy adapters: [tomcat9(credentialsId: '043364ef-3091-48db-aaff-ef4781f38373', path: '', url: 'http://http://http://ec2-100-25-188-179.compute-1.amazonaws.com:8080/')], contextPath: null, war: '**/*.war'
      }
    }
